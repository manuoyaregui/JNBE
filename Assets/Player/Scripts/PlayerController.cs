...
{
    //En este script manejamos la comunicacion con otros scripts del player y la interaccion con el exterior
    /*[SerializeField] PlayerParticlesController _particlesController;
